...
def get_predictions(texts):
    return smiley_predict.predict_batch(texts) #zip(smiley_predict.predict_batch(texts), sentiment.predict_batch(texts))

writefile = open('/home/hardwick/s24_100K_random_sentences_annotated.txt', "w", encoding = "utf-8")
...
for line in open('/home/hardwick/s24_100K_random_sentences.txt', 'r', encoding='utf-8'):
    if i % 3 == 0:
